...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white md:bg-gray-900 text-gray-900 md:text-white">
      ...
      {/* Navigation Menu - Desktop only - Smaller */}
            ...
            {categories.map((category) => (
              <Link
                ...
                className={`text-gray-300 hover:text-white whitespace-nowrap px-4 py-2 rounded-lg hover:bg-gray-800 transition-colors text-caption font-medium btn-professional focus-professional ${
                  category.name === "All" ? "bg-red-600 text-white" : ""
                }`}
              >
                {category.name}
              </Link>
        ...
        <div className="flex gap-8">
          ...
          <main className="flex-1">
            ...
            <div className="mb-8 p-6 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg text-white text-center">
              ...
              <div className="mt-2 text-xs opacity-75">Bu alan reklam entegrasyonu için hazırlanmıştır</div>
            </div>
            ...
            <div className="flex justify-center items-center space-x-4 mt-12 pt-8 border-t border-gray-200 md:border-gray-800">
              <span className="text-gray-600 md:text-gray-400 text-caption">Showing {videos.length} videos, Page 1</span>
          ...
          <aside className="hidden md:block w-72 bg-black rounded-xl p-6 h-fit shadow-professional-lg">
            <h2 className="text-white text-title mb-6">Categories</h2>
            ...
            {/* Featured Section */}
            <div className="mt-10">
              <h3 className="text-white text-title mb-6">New Releases</h3>
            ...
            {/* Video Archive Dropdown */}
            <div className="mt-10">
              <h3 className="text-white text-title mb-6">Video Archive</h3>
